...
var education = {
	...
	display: function () {
		for(school in education.schools) {
			...
			for(qualification in education.schools[school].qualifications){
...
//var formattedWorkDates = HTMLworkDates.replace("%data%", work.jobs.dates[0]);
//var formattedWorkDescription = HTMLworkDescription.replace("%data%", work.jobs.description[0]);




	//Work Experience - append/prepend technique
